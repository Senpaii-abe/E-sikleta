...
<title>E-Bike Rental | Home</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1 style="color: Green; text-shadow: 4px 5px 4px #000000;">Get a chance to ride your favorite E-Bike.</h1>

            <p>We have the cheapest E-bike for you to choose.</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>E-Bike For You</span></h2>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewbike" role="tab" data-toggle="tab">New E-Bike</a></li>
        </ul>
      </div>
...
<span class="price">P<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user" aria-hidden="true"></i>3+</h2>
